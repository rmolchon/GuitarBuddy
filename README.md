...
V1 (Tuner + Key Finder) is under active development. `Core/` (music theory, audio math, tuning presets) is complete and unit-tested; the audio capture pipeline and SwiftUI screens are next. See `CLAUDE.md` for the detailed build order and architecture notes.
